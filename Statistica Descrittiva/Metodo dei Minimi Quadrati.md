I *coefficienti di [[Regressione Lineare Semplice|regressione]]* non sono noti; sono parametri da *stimare sulla base dei dati osservati*, in modo che la retta di regressione si adatti bene alle osservazioni.
